...
const PostWrite = (props) =>{
    ...
    return(
        ...
        <Grid is_flex  flexDirection = "column"> 
            <Grid is_flex  flexDirection = "column" border = "3px solid black" width = "80%" margin = "5% 70% 1% 70%"padding = "1%">
        <Grid is_flex  width = '46%'>
            ...
            <Text bold size ="25px">title</Text>
            <TextArea onChange = {texTtitle} rows = {2} ></TextArea> 
            <Text bold size ="25px">content</Text>
